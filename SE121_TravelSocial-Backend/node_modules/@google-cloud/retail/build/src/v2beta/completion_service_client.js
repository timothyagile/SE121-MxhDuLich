...
class CompletionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importCompletionDataResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportCompletionDataResponse');
        const importCompletionDataMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2beta.CompletionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.completionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2beta.CompletionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2beta.CompletionService, this._opts, this._providedCustomServicePath);
