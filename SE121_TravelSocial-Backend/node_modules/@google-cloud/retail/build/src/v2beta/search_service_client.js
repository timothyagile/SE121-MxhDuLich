...
class SearchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2beta.SearchService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.searchServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2beta.SearchService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2beta.SearchService, this._opts, this._providedCustomServicePath);
    ...
    search(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                placement: (_a = request.placement) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     * @returns {string} Resource name string.
     */
    experimentPath(project, location, catalog, experiment) {
     ...
     * @returns {string} A string representing the catalog.
     */
    matchCatalogFromExperimentName(experimentName) {
        return this.pathTemplates.experimentPathTemplate.match(experimentName)
            .catalog;
    }
    /**
