...
class ProductServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const purgeProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.PurgeProductsResponse');
        const purgeProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.PurgeProductsMetadata');
        const importProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportProductsResponse');
        const importProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportMetadata');
        const exportProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ExportProductsResponse');
        const exportProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ExportMetadata');
        const setInventoryResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.SetInventoryResponse');
        const setInventoryMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.SetInventoryMetadata');
        const addFulfillmentPlacesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.AddFulfillmentPlacesResponse');
        const addFulfillmentPlacesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.AddFulfillmentPlacesMetadata');
        const removeFulfillmentPlacesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RemoveFulfillmentPlacesResponse');
        const removeFulfillmentPlacesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RemoveFulfillmentPlacesMetadata');
        const addLocalInventoriesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.AddLocalInventoriesResponse');
        const addLocalInventoriesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.AddLocalInventoriesMetadata');
        const removeLocalInventoriesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RemoveLocalInventoriesResponse');
        const removeLocalInventoriesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RemoveLocalInventoriesMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2beta.ProductService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2beta.ProductService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2beta.ProductService, this._opts, this._providedCustomServicePath);
