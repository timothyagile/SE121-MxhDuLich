...
class UserEventServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const purgeUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.PurgeUserEventsResponse');
        const purgeUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.PurgeMetadata');
        const importUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportUserEventsResponse');
        const importUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ImportMetadata');
        const exportUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ExportUserEventsResponse');
        const exportUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.ExportMetadata');
        const rejoinUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RejoinUserEventsResponse');
        const rejoinUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.RejoinUserEventsMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2beta.UserEventService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userEventServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2beta.UserEventService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2beta.UserEventService, this._opts, this._providedCustomServicePath);
