...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.Model');
        const createModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.CreateModelMetadata');
        const tuneModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2beta.TuneModelResponse');
        const tuneModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2beta.TuneModelMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2beta.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2beta.ModelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2beta.ModelService, this._opts, this._providedCustomServicePath);
