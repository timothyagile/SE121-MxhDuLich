...
export declare class UserEventServiceClient {
     ...
     */
    exportUserEvents(request?: protos.google.cloud.retail.v2beta.IExportUserEventsRequest, options?: CallOptions): Promise<[
    ...
    exportUserEvents(request: protos.google.cloud.retail.v2beta.IExportUserEventsRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.retail.v2beta.IExportUserEventsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    exportUserEvents(request: protos.google.cloud.retail.v2beta.IExportUserEventsRequest, callback: Callback<LROperation<protos.google.cloud.retail.v2beta.IExportUserEventsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:retail_v2beta_generated_UserEventService_ExportUserEvents_async
     */
    checkExportUserEventsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2beta.ExportUserEventsResponse, protos.google.cloud.retail.v2beta.ExportMetadata>>;
    /**
