...
export declare class ProjectServiceClient {
     ...
     */
    getAlertConfig(request?: protos.google.cloud.retail.v2beta.IGetAlertConfigRequest, options?: CallOptions): Promise<[
        protos.google.cloud.retail.v2beta.IAlertConfig,
        protos.google.cloud.retail.v2beta.IGetAlertConfigRequest | undefined,
        {} | undefined
    ]>;
    getAlertConfig(request: protos.google.cloud.retail.v2beta.IGetAlertConfigRequest, options: CallOptions, callback: Callback<protos.google.cloud.retail.v2beta.IAlertConfig, protos.google.cloud.retail.v2beta.IGetAlertConfigRequest | null | undefined, {} | null | undefined>): void;
    getAlertConfig(request: protos.google.cloud.retail.v2beta.IGetAlertConfigRequest, callback: Callback<protos.google.cloud.retail.v2beta.IAlertConfig, protos.google.cloud.retail.v2beta.IGetAlertConfigRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateAlertConfig(request?: protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest, options?: CallOptions): Promise<[
        protos.google.cloud.retail.v2beta.IAlertConfig,
        protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest | undefined,
        {} | undefined
    ]>;
    updateAlertConfig(request: protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest, options: CallOptions, callback: Callback<protos.google.cloud.retail.v2beta.IAlertConfig, protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest | null | undefined, {} | null | undefined>): void;
    updateAlertConfig(request: protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest, callback: Callback<protos.google.cloud.retail.v2beta.IAlertConfig, protos.google.cloud.retail.v2beta.IUpdateAlertConfigRequest | null | undefined, {} | null | undefined>): void;
    /**
