 ...
 * @memberof v2alpha
 */
export declare class BranchServiceClient {
    private _terminated;
    private _opts;
     ...
     */
    listBranches(request?: protos.google.cloud.retail.v2alpha.IListBranchesRequest, options?: CallOptions): Promise<[
    ...
    listBranches(request: protos.google.cloud.retail.v2alpha.IListBranchesRequest, options: CallOptions, callback: Callback<protos.google.cloud.retail.v2alpha.IListBranchesResponse, protos.google.cloud.retail.v2alpha.IListBranchesRequest | null | undefined, {} | null | undefined>): void;
    listBranches(request: protos.google.cloud.retail.v2alpha.IListBranchesRequest, callback: Callback<protos.google.cloud.retail.v2alpha.IListBranchesResponse, protos.google.cloud.retail.v2alpha.IListBranchesRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    getBranch(request?: protos.google.cloud.retail.v2alpha.IGetBranchRequest, options?: CallOptions): Promise<[
        protos.google.cloud.retail.v2alpha.IBranch,
        protos.google.cloud.retail.v2alpha.IGetBranchRequest | undefined,
        {} | undefined
    ]>;
    getBranch(request: protos.google.cloud.retail.v2alpha.IGetBranchRequest, options: CallOptions, callback: Callback<protos.google.cloud.retail.v2alpha.IBranch, protos.google.cloud.retail.v2alpha.IGetBranchRequest | null | undefined, {} | null | undefined>): void;
    getBranch(request: protos.google.cloud.retail.v2alpha.IGetBranchRequest, callback: Callback<protos.google.cloud.retail.v2alpha.IBranch, protos.google.cloud.retail.v2alpha.IGetBranchRequest | null | undefined, {} | null | undefined>): void;
    /**
