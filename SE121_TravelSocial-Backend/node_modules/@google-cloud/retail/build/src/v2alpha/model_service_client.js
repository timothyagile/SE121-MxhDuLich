...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.Model');
        const createModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.CreateModelMetadata');
        const tuneModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.TuneModelResponse');
        const tuneModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.TuneModelMetadata');
        this.descriptors.longrunning = {
            ...
            tuneModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, tuneModelResponse.decode.bind(tuneModelResponse), tuneModelMetadata.decode.bind(tuneModelMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.ModelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.ModelService, this._opts, this._providedCustomServicePath);
    ...
    pauseModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    resumeModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    tuneModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkTuneModelProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
