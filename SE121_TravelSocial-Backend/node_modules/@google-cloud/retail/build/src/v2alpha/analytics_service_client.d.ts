 ...
 * @memberof v2alpha
 */
export declare class AnalyticsServiceClient {
    private _terminated;
    private _opts;
     ...
     */
    exportAnalyticsMetrics(request?: protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsRequest, options?: CallOptions): Promise<[
    ...
    exportAnalyticsMetrics(request: protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.IExportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    exportAnalyticsMetrics(request: protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsRequest, callback: Callback<LROperation<protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.IExportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:retail_v2alpha_generated_AnalyticsService_ExportAnalyticsMetrics_async
     */
    checkExportAnalyticsMetricsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.ExportMetadata>>;
    /**
