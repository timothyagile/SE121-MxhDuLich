...
exports.MerchantCenterAccountLinkServiceClient = void 0;
 ...
 */
const gapicConfig = require("./merchant_center_account_link_service_client_config.json");
...
class MerchantCenterAccountLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createMerchantCenterAccountLinkResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.MerchantCenterAccountLink');
        const createMerchantCenterAccountLinkMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.CreateMerchantCenterAccountLinkMetadata');
        this.descriptors.longrunning = {
            createMerchantCenterAccountLink: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createMerchantCenterAccountLinkResponse.decode.bind(createMerchantCenterAccountLinkResponse), createMerchantCenterAccountLinkMetadata.decode.bind(createMerchantCenterAccountLinkMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.MerchantCenterAccountLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.merchantCenterAccountLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.MerchantCenterAccountLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha
                    .MerchantCenterAccountLinkService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of merchantCenterAccountLinkServiceStubMethods) {
            const callPromise = this.merchantCenterAccountLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listMerchantCenterAccountLinks(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    deleteMerchantCenterAccountLink(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createMerchantCenterAccountLink(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateMerchantCenterAccountLinkProgress(name) {
...
exports.MerchantCenterAccountLinkServiceClient = MerchantCenterAccountLinkServiceClient;
//# sourceMappingURL=merchant_center_account_link_service_client.js.map