...
class ProductServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const purgeProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.PurgeProductsResponse');
        const purgeProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.PurgeProductsMetadata');
        const importProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportProductsResponse');
        const importProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportMetadata');
        const exportProductsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportProductsResponse');
        const exportProductsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportMetadata');
        const setInventoryResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.SetInventoryResponse');
        const setInventoryMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.SetInventoryMetadata');
        const addFulfillmentPlacesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.AddFulfillmentPlacesResponse');
        const addFulfillmentPlacesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.AddFulfillmentPlacesMetadata');
        const removeFulfillmentPlacesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponse');
        const removeFulfillmentPlacesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesMetadata');
        const addLocalInventoriesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.AddLocalInventoriesResponse');
        const addLocalInventoriesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.AddLocalInventoriesMetadata');
        const removeLocalInventoriesResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RemoveLocalInventoriesResponse');
        const removeLocalInventoriesMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RemoveLocalInventoriesMetadata');
        this.descriptors.longrunning = {
            ...
            exportProducts: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportProductsResponse.decode.bind(exportProductsResponse), exportProductsMetadata.decode.bind(exportProductsMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.ProductService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.ProductService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.ProductService, this._opts, this._providedCustomServicePath);
    ...
    exportProducts(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportProductsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
