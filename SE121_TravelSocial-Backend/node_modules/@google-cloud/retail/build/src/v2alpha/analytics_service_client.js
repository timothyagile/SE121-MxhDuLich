...
exports.AnalyticsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./analytics_service_client_config.json");
...
class AnalyticsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const exportAnalyticsMetricsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportAnalyticsMetricsResponse');
        const exportAnalyticsMetricsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportMetadata');
        this.descriptors.longrunning = {
            exportAnalyticsMetrics: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportAnalyticsMetricsResponse.decode.bind(exportAnalyticsMetricsResponse), exportAnalyticsMetricsMetadata.decode.bind(exportAnalyticsMetricsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.AnalyticsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.analyticsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.AnalyticsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.AnalyticsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of analyticsServiceStubMethods) {
            const callPromise = this.analyticsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    exportAnalyticsMetrics(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
     ...
     */
    async checkExportAnalyticsMetricsProgress(name) {
...
//# sourceMappingURL=analytics_service_client.js.map