...
class UserEventServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const purgeUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.PurgeUserEventsResponse');
        const purgeUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.PurgeMetadata');
        const importUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportUserEventsResponse');
        const importUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportMetadata');
        const exportUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportUserEventsResponse');
        const exportUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ExportMetadata');
        const rejoinUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RejoinUserEventsResponse');
        const rejoinUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.RejoinUserEventsMetadata');
        this.descriptors.longrunning = {
            ...
            exportUserEvents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportUserEventsResponse.decode.bind(exportUserEventsResponse), exportUserEventsMetadata.decode.bind(exportUserEventsMetadata)),
            rejoinUserEvents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rejoinUserEventsResponse.decode.bind(rejoinUserEventsResponse), rejoinUserEventsMetadata.decode.bind(rejoinUserEventsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.UserEventService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userEventServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.UserEventService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.UserEventService, this._opts, this._providedCustomServicePath);
    ...
    exportUserEvents(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportUserEventsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    rejoinUserEvents(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRejoinUserEventsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
