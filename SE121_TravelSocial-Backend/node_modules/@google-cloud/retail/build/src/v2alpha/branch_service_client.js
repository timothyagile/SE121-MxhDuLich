...
exports.BranchServiceClient = void 0;
 ...
 */
const gapicConfig = require("./branch_service_client_config.json");
...
class BranchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.BranchService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.branchServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.BranchService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.BranchService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const branchServiceStubMethods = ['listBranches', 'getBranch'];
        for (const methodName of branchServiceStubMethods) {
            const callPromise = this.branchServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listBranches(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getBranch(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.BranchServiceClient = BranchServiceClient;
//# sourceMappingURL=branch_service_client.js.map