...
exports.GenerativeQuestionServiceClient = void 0;
 ...
 */
const gapicConfig = require("./generative_question_service_client_config.json");
...
class GenerativeQuestionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.GenerativeQuestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.generativeQuestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.GenerativeQuestionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha
                    .GenerativeQuestionService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of generativeQuestionServiceStubMethods) {
            const callPromise = this.generativeQuestionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateGenerativeQuestionsFeatureConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'generative_questions_feature_config.catalog': (_a = request.generativeQuestionsFeatureConfig.catalog) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateGenerativeQuestionsFeatureConfig(request, options, callback);
    }
    getGenerativeQuestionsFeatureConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listGenerativeQuestionConfigs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateGenerativeQuestionConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'generative_question_config.catalog': (_a = request.generativeQuestionConfig.catalog) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateGenerativeQuestionConfig(request, options, callback);
    }
    batchUpdateGenerativeQuestionConfigs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.GenerativeQuestionServiceClient = GenerativeQuestionServiceClient;
//# sourceMappingURL=generative_question_service_client.js.map