...
class CompletionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importCompletionDataResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportCompletionDataResponse');
        const importCompletionDataMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.ImportMetadata');
        this.descriptors.longrunning = {
            importCompletionData: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importCompletionDataResponse.decode.bind(importCompletionDataResponse), importCompletionDataMetadata.decode.bind(importCompletionDataMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.CompletionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.completionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.CompletionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.CompletionService, this._opts, this._providedCustomServicePath);
    ...
    importCompletionData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkImportCompletionDataProgress(name) {
