...
class ProjectServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const enrollSolutionResponse = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.EnrollSolutionResponse');
        const enrollSolutionMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2alpha.EnrollSolutionMetadata');
        this.descriptors.longrunning = {
            enrollSolution: new this._gaxModule.LongrunningDescriptor(this.operationsClient, enrollSolutionResponse.decode.bind(enrollSolutionResponse), enrollSolutionMetadata.decode.bind(enrollSolutionMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2alpha.ProjectService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.projectServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2alpha.ProjectService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2alpha.ProjectService, this._opts, this._providedCustomServicePath);
    ...
    acceptTerms(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listEnrolledSolutions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getLoggingConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateLoggingConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'logging_config.name': (_a = request.loggingConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateLoggingConfig(request, options, callback);
    }
    getAlertConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateAlertConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'alert_config.name': (_a = request.alertConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateAlertConfig(request, options, callback);
    }
    enrollSolution(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkEnrollSolutionProgress(name) {
