...
export declare class CompletionServiceClient {
     ...
     */
    completeQuery(request?: protos.google.cloud.retail.v2alpha.ICompleteQueryRequest, options?: CallOptions): Promise<[
    ...
    completeQuery(request: protos.google.cloud.retail.v2alpha.ICompleteQueryRequest, options: CallOptions, callback: Callback<protos.google.cloud.retail.v2alpha.ICompleteQueryResponse, protos.google.cloud.retail.v2alpha.ICompleteQueryRequest | null | undefined, {} | null | undefined>): void;
    completeQuery(request: protos.google.cloud.retail.v2alpha.ICompleteQueryRequest, callback: Callback<protos.google.cloud.retail.v2alpha.ICompleteQueryResponse, protos.google.cloud.retail.v2alpha.ICompleteQueryRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    importCompletionData(request?: protos.google.cloud.retail.v2alpha.IImportCompletionDataRequest, options?: CallOptions): Promise<[
    ...
    importCompletionData(request: protos.google.cloud.retail.v2alpha.IImportCompletionDataRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.retail.v2alpha.IImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    importCompletionData(request: protos.google.cloud.retail.v2alpha.IImportCompletionDataRequest, callback: Callback<LROperation<protos.google.cloud.retail.v2alpha.IImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:retail_v2alpha_generated_CompletionService_ImportCompletionData_async
     */
    checkImportCompletionDataProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.ImportMetadata>>;
    /**
