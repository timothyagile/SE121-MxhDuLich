const Booking = require('../models/bookingModel/Booking').Booking
const ServiceBooked = require('../models/bookingModel/Booking').ServiceBooked
const Location = require('../models/generalModel/Location')
const Service = require('../models/bookingModel/Service')
const Room = require('../models/bookingModel/Room')
